 ...
 *
 * A tela de obrigado monta isto e o número zera sozinho.
 *
 ...
 */
export function RecarregaSacola() {
  const sacola = useSacola()

  useEffect(() => {
    sacola?.recarregar()
    // Só na montagem: `sacola` muda de identidade a cada leitura, e reagir a
    // ela aqui seria um laço infinito de idas ao servidor.
